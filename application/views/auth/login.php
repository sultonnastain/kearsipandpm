...
<head>
    ...
    <title>Portal Kearsipan DPM Vokasi UB</title>
...
<body class="bg-gradient-primary" style="background-image: url(assets/img/bg.jpg);">
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image" style="background-image: url(assets/img/lkm.jpg);"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
