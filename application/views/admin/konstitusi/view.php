...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Konstitusi DPM Vokasi UB</h1>
<p class="mb-4">Berikut merupakan Konstitusi berupa kebijakan kebijakan berupa undang undang, SOP maupun SP DPM Vokasi Universitas Brawijaya.</p>
...
<div class="modal fade" id="modal-tambah">
          ...
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Tambah Data Konstitusi</h4>
