...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Absensi dan Notulensi Rapat Besar DPM Vokasi UB</h1>
<p class="mb-4">Berikut merupakan notulensi dan absensi kegiatan Rapat Besar DPM Vokasi Universitas Brawijaya.</p>
...
<div class="modal fade" id="modal-tambah">
          ...
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Tambah Data Rabes</h4>
            ...
            <div class="col-lg-12">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" autocomplete="off" name="tanggal" id="tgl_rabes" placeholder="Masukkan Tanggal Rabes">
                </div>
            </div>
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
              <button type="submit" id="submit_save" name="submit" class="btn btn-primary">Simpan</button>
            </div>
            </form>
          </div>
          <!-- /.modal-content -->
